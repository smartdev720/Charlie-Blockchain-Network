    ...
    return (
        <div className="relative cursor-pointer" onClick={() => setSelected(name)}>
            <div className="wallet-card-wrapper relative bg-[#2C2C2C] h-[100px]">
                <div className={`wallet-card-wrapper absolute hover:bg-[#2C2C2C] transition-all duration-300 ease-in-out inset-[1px] bg-[#212121] flex flex-col items-center justify-center
                    ${selected === name ? "bg-[#2C2C2C]" : ""}`}>
